...
my_list2 = [el for el in range(20, 241) if el % 20 == 0 or el % 21 == 0]
print(my_list2)
...
my_list3 = [randint(-10, 10) for _ in range(20)]
...
def multiply(x_1, x_2):
    return x_1 * x_2


my_list5 = [el for el in range(100, 1001, 2)]
print(f'Список: \n{my_list5}\nУмноженные числа: \n{reduce(multiply, my_list5)}')
